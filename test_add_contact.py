...
class test_add_contact(unittest.TestCase):
    ...
    def test_add_new_contact(self):
        ...
        self.add_new_contact (wd, Contact(firstname="Tony", middlename="nnnn", lastname="Wendice", nickname="mmm", title="mhfgj", company="gfhfghfgs", address="dfgdg dg dgd.d hdhfh",
